...
- Store orders (Paystack): `cancelled`/`canceled`/`failed` trigger an automatic Paystack refund (`refundCancelledItem`, REFUNDABLE_STATUSES in storeOrderDelivery); error/rejected/404 stay manual by design.
